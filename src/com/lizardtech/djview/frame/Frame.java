...
public class Frame
    ...
    private final Button back = new Button("Prapa");
    private final Button forward = new Button("Perpara");
        ...
        appletContext =
                new AppletContext() {
                    ...
                    public void showStatus(final String status) {
                        DjVuOptions.out.println("gjendja: " + status);
                    }
        ...
        if (url != null) {
            ...
            if (url.getProtocol().equals("file")) {
                ...
                if (f.isDirectory()) {
                    ...
                    final StringBuffer text = new StringBuffer("<html><head>Indeksi i " + path + "</head><body><h1>Indeksi i " + path + "</h1><table><tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><b>Emri</b></td><td><b>Modifikimi i fundit</b></td><td><b>Madhesia</b></td></tr>\n");
                    try {
                        printFile(text, f.getParentFile(), "<em>Direktoria prind</em>");
                    } catch (final Throwable exp) {
...
//          use reflection for gcj compatability.
        ...
        if (component == null) {
            component = new TextArea("Asnje e dhene e ngarkuar");
        }
